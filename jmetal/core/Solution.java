...
public class Solution implements Serializable {
	...
	/**
	 * Stores the so called rank of the solution. Used in NSGA-II, also used in
	 * R2MOGA, MOMBI
	 */
	private int rank_;
	...
	private double pDistance_;
	
	
	
	/**
	 * Stores the R2 contribution of the the solution in a
	 * <code>SolutionSet</code>. Used in R2MOGA.
	 */
	private double r2Contribution_;
	
	
	private double bestUtilityValue;   //used in MOMBI
	
	private double currentUtilityValue;  //used in MOMBI
	
	
	private double fuzzyFitnessMeasure; 
	
	private double deltaFitnessMeasure;
	
	
	
	private double[] normalizedObjective_;
	
	private double[] boxObjective_;  // used in Epsilon-MOEA
	
	/**
	 * Stores the contribution of the the solution in a
	 * <code>SolutionSet</code>. Used in GrEA.
	 */
	private int [] grid_coord_;
	
	private int grid_rank_;				// Solution's grid ranking (GR)
	
	private int grid_crowd_dist_;		// Solution's grid crowding distance (GCD)
	
	private double grid_distance_;		// Solution's grid coordinate point distance(GCPD)

	private int max_punishment_;		// The max punishment value for environmental selection
	
	public int getMaxPunishment()
	{
		return this.max_punishment_;
	}
	
	public void setMaxPunishment(int value)
	{
		this.max_punishment_=value;
	}
	
	public void setGridCorrd(int ind, int value)
	{
		this.grid_coord_[ind] = value;
	}
	
	public int getGridCorrd(int ind)
	{	
		return this.grid_coord_[ind];
	}
	

	
	public void setGridCrowdDist(int grid_crod_dist)
	{
		this.grid_crowd_dist_ = grid_crod_dist;
	}
	public int getGridCrowdDist()
	{
		return this.grid_crowd_dist_;
	}
	
	public void setGridRank(int grid_rank)
	{
		this.grid_rank_=grid_rank;
	}
	
	public int getGridRank()
	{
		return this.grid_rank_;
	}
	
	public void setGridDistance(double grid_distance)
	{
		this.grid_distance_=grid_distance;
	}
	
	public double getGridDistance()
	{
		return this.grid_distance_ ;
	}
	...
	private int[] gridObjective_;
	
	private int GR_;  
	
	private int GCD_;
	
	private double GCPD_;
	
	private int PD_;
	
	public void setGR(int val){
		this.GR_ = val;
	}
	...
	public void setGCPD(double val){
		this.GCPD_ = val;
	}
	...
	public void setGridObjective(int i, int val){
		gridObjective_[i] = val;
	}
	
	
	public int getGridObjective(int i){
		return gridObjective_[i];
	}
	/**
	 * Constructor.
	 */
	...
	public Solution(int numberOfObjectives) {
		...
		boxObjective_ = new double[numberOfObjectives_];
		
		grid_coord_ =new int[numberOfObjectives_];	//used in GrEA
		gridObjective_ =new int[numberOfObjectives_];  //used in  new GrEA
	}
	...
	public Solution(Problem problem) throws ClassNotFoundException {
		...
		grid_coord_ =new int[numberOfObjectives_];
		gridObjective_ =new int[numberOfObjectives_];
...
//		r2Contribution_ = 0.0;
	...
	public Solution(Problem problem, Variable[] variables) {
		...
		// Initial the Grid coordinate value
		grid_coord_ =new int[numberOfObjectives_];
		gridObjective_ =new int[numberOfObjectives_];
...
//		r2Contribution_ = 0.0;
	...
	public Solution(Solution solution) {
		...
		for (int i = 0; i < objective_.length; i++) {
			...
			boxObjective_[i] = solution.getBoxObjective(i);
		} // for
		...
		for (int i = 0; i < objective_.length; i++) {
			...
			normalizedObjective_[i] = solution.getNormalizedObjective(i);
			boxObjective_[i] = solution.getBoxObjective(i);
			gridObjective_[i] = solution.getGridObjective(i);
		} // for
		// <-
		...
		r2Contribution_= solution.getR2Contribution();
	} // Solution
	...
	public void setR2Contribution(double val) {
		this.r2Contribution_ = val;
	}

	public double getR2Contribution() {
		return this.r2Contribution_;
	}
	
	public void setBestUtilityValue(double val){
		this.bestUtilityValue = val;
	}
	public double getBestUtilityValue(){
		return this.bestUtilityValue;
	}

	public void setCurrentUtilityValue(double val){
		this.currentUtilityValue = val;
	}
	public double getCurrentUtilityValue(){
		return this.currentUtilityValue;
	}


	
	public void setFuzzyFitnessMeausre(double val){
		this.fuzzyFitnessMeasure = val;
	}

	public double getFuzzyFitnessMeasure(){
		return this.fuzzyFitnessMeasure;
	}
	
	
	
	public void setDeltaFitnessMeausre(double val){
		this.deltaFitnessMeasure = val;
	}

	public double getDeltaFitnessMeasure(){
		return this.deltaFitnessMeasure;
	}
	...
	public void setBoxObjective(int i, double value) {
		boxObjective_[i] = value;
	}

	public double getBoxObjective(int i) {
		return boxObjective_[i];
	}
	...
	public void setPDistance(double val){
		this.pDistance_ = val;
	}
	
	public double getPDistance(){
		return this.pDistance_;
	}
	
	public boolean equal(Solution sol){
		int times=0;
		for(int i=0;i<this.numberOfObjectives_;i++){
			if(this.getObjective(i)==sol.getObjective(i)){
				times++;
			}
		}
		if(times==this.numberOfObjectives_)
			return true;
		else
			return false;
	}
