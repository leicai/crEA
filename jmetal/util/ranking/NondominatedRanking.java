...
public class NondominatedRanking implements Ranking {
  ...
  public NondominatedRanking(SolutionSet solutionSet) {        
    ...
    // 此处是算法的第一步，开始进行排序，对群体中的每一个个体寻找他的n_p 和S_p 
    ...
    // The second part of fast-non-dominated-sort 
    ...
    //<-
    // the ranking_ is an array that stores set of solutions which has been ranked!    
