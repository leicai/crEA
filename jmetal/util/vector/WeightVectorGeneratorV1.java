...
public class WeightVectorGeneratorV1 extends VectorGenerator {
	...
	public WeightVectorGeneratorV1(int divisions, int m){
		this.divisions = divisions;
		this.m = m;
		
		int N = getCombin(m + divisions - 1, divisions);//  C_{M+p-1}^{p} // The total number of N
